...
The value vision trainer was created in Python using streamlit for the interface. You can find the program here: https://value-vision-trainer.streamlit.app/
